...
setTimeout(function(){
    document.getElementById('text-show').className = 'hiddentext';
}, 16000);

setTimeout(function(){
    document.getElementById('show-after').className = 'showtext';
}, 16500);